			...
			<legend>General Information</legend>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				    ...
				    <a href="CreateAbuseReportViewPage.jsp" id="save" name="save" class="btn btn-primary">Save</a>
				    <a href="CreateAbuseReportViewPage.jsp" id="cancel" name="submit" class="btn btn-success">Submit for Approval</a>
				  </div>
				</div>
			</fieldset>
			</form>
